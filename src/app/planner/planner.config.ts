...
export const PLANNER_OPTIMIZATION_CONFIG: any = [
    ...
    { name: 'measureService', label: 'Measure Service', type: 'select', selections: ['osmap', 'gmap'], selectionLabels: ['Open Street Map', 'Google Map'], default: 'osmap', rowIndex: 1, readOnly: true },
