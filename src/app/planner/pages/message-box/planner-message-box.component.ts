...
export class PlannerMessageBoxComponent implements OnInit, OnDestroy {
    ...
    filter(searchTerm: string = undefined) {
        ...
        this.filteredMessages = PlannerUtils.filterArrayBySearchTerm(searchTerm, this.messages, ['driverRemarks', 'fromUser.username', 'fromUser.username', 'job.DeliveryMasterId', 'job.ContactName', 'job.Postal'])
            .sort((a, b) => {
