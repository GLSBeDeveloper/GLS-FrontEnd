...
export class VrpProblemRestService {
    ...
    queryDistanceMatrix(id: string, settings: any): Observable<any> {
        return this._http.post(`${this._baseUrl}/v2/distanceMatrix/${id}`, settings);
    }

    optimize(id: string, settings: any): Observable<any> {
        return this._http.post(`${this._baseUrl}/v2/optimize/${id}`, settings);
    }
